...
![D3.js](https://img.shields.io/badge/D3.js-Visualization%20Expert-F9A03C?style=for-the-badge\&logo=d3dotjs\&logoColor=black)
...
```mermaid
flowchart TD
    A[Usuario/Descarga] -->|ZIP| B[Airflow DAG]
    B --> C[Procesamiento Pandas + SQL]
    C --> D[PostgreSQL DB]
    D --> E[Power BI]
    D --> F[D3.js Dash]
    B --> G[Logs & Alerts]
...
<details open>
<summary>📊 Estadísticas y lenguajes más usados</summary>
...
<details>
<summary>🧠 Últimos artículos y progreso diario (auto‑update)</summary>
